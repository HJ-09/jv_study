...
1. Collections Framework란?
	...
	•	List(순서가 있는 자료. 길이변경 가능), Set(순서가 없는 자료. 중복제거), Map(순서가 없는 자료. Key(Set과 동일)와 Value로 되어 있는 자료) 인터페이스들과 이를 구현한 다양한 클래스들로 구성
...
📒 Iterator (17~20)
	...
	17.	Iterator에서 다음요소가 남아있는지 확인하는 메서드는?
