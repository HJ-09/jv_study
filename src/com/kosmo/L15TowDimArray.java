...
public class L15TowDimArray {
    public static void main(String[] args) {
        ...
        //배열을 리터럴하게 표기할 때는 ({}) ⇒ 꼭 선언과 동시에 대입
        arr=new int[][]{};
        int ns[]={1,2,3,4};
        //ns={5,6,7}; //선언과 동시에 대입이 아니라서 오류
        ns=new int[]{5,6,7}; //변수에 다시 리터럴하게 선언하는 방법
        ...
        for(int i=0; i<scoreTwos.length; i++){
            ...
            //i==1 {100,66,89}  66⇒scoreTwos[1][1]
            //i==2 {81,100,100}  81⇒scoreTwos[1][0]
