...
*/
    ...
    public static void main(String[] args) {
        ...
        JPanel p=new JPanel(); //기본은 BorderLayout임. 모든 컨테이너가 BorderLayout을 기본으로 사용~
        ...
        JLabel label=new JLabel("하이!");

        frame.add(label); //중간에 넣을 때는 "Center"를 생략해도 댐! 센터 아닐 땐 지정해조야함.
        //frame.add(btn,"North"); ⇔ frame.add(btn, BorderLayout.NORTH);
